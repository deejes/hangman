        ...
        if len(user_guess) != 1:
            ...
            if user_guess not in word:
                ...
                if counter == difficulty:
                    ...
                    return False
                print("Sorry, thats not in there, and you have %s guesses left." % (
                    difficulty - counter))
            else:
                print("Yes, the word contains a/an %s!" % user_guess)
                letter_indices = [m.start()
                                  for m in re.finditer(user_guess, word)]
    ...
    while True:
        ...
        if not difficulty_condition:
            user_difficulty = raw_input(
                "Do you want easy, medium, or hard diffculty?")
        ...
        if wtp == "yes" or wtp == "y":
            ...
            print("thanks for playing, you won %s games and lost %d games." %
                  (won, lost))
            break
